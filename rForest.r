...
# values = list(y_pred , cm ,  total_test_set_rows)

# names(values) <- c("y_pred", "cm", "total_test_set_rows")

accuracy = sum(diag(cm)) / total_test_set_rows
...
#correlationMatrix <- cor(dataset[,c(1,4,5)])
